...
SUBJECT_MATCH_FOUND = 'Found pattern match in file %s [log watcher]';
SUBJECT_FILE_REMOVED = '%s file has been removed [log watcher]';

BODY_MATCH_FOUND = 'Found pattern match in file %s\n' +
                   'Pattern: %s\n' +
                   'Matched line: %s\n' +
                   'Time: %s';
BODY_FILE_REMOVED = 'File %s has been removed at %s.';


function EmailNotificationPlugin(options) {
  NotificationPlugin.call(this, options);
}
